...
public class Settings : MonoBehaviour
{
    ...
    /// <summary>
    /// Called when a new player joins the game via the Player Input Manager
    /// </summary>
    /// <param name="playerInput">Player Input component of the joined player</param>
    ...
    /// <summary>
    /// Called when a player leaves the game via the Player Input Manager
    /// </summary>
    /// <param name="playerInput">Player Input component of the leaving player</param>
